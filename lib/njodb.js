...
const selectStoreData = function(store, selector, lockoptions, debug) {
    return new Promise ((resolve, reject) => {
        const start = Date.now();
        var selected = 0;
        var ignored = 0;
...
const deleteStoreData = function(store, selector, tempstore, lockoptions, debug) {
    return new Promise((resolve, reject) => {
        const start = Date.now();
        var deleted = 0;
        var retained = 0;
...
const updateStoreData = function(store, selector, updator, tempstore, lockoptions, debug) {
    return new Promise((resolve, reject) => {
        const start = Date.now();
        var updated = 0;
        var unchanged = 0;
