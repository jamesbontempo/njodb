...
class StatsHandler {
    constructor() {
        this.results = objects.Result("stats");
        return this;
    }
    ...
    return() {
        ...
        this.results.elapsed = this.results.end - this.results.start;
        return this.results;
    }
}
...
class SelectHandler {
    constructor(selecter, projecter) {
        ...
        this.results = objects.Result("select");
        return this;
    }
...
class UpdateHandler {
    constructor(selecter, updater) {
        ...
        this.results = objects.Result("update");
        return this;
    }
...
class DeleteHandler {
    constructor(selecter) {
        this.selecter = selecter;
        this.results = objects.Result("delete");
        return this;
    }
...
class AggregateHandler {
    constructor(selecter, indexer, projecter) {
        ...
        this.projecter = projecter;
        this.results = objects.Result("aggregate");
    }
